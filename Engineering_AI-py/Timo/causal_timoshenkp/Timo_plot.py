...
with open('causal_timo.pkl', 'rb') as f:
...
plt.savefig('Causal_timo_disp.pdf', dpi=500, bbox_inches="tight", format='pdf', backend='cairo')
...
plt.savefig('Causal_timo_rotation.pdf', dpi=500, bbox_inches="tight", format='pdf',  backend='cairo')
#plt.savefig('Causal_EB.pdf', dpi=500, bbox_inches="tight", format='pdf', backend='cairo')
...
#CS1 = plt.tricontourf(x_test, t_test, u_test_pred, 20, cmap='twilight')
CS1 = plt.tricontourf(x_test, t_test, u_test, levels, cmap='Spectral_r')
#CS1 = plt.tricontourf(x_test, t_test, relative_error, 20, cmap='rainbow')
...
plt.savefig('Exact_timo_disp.pdf', dpi=500, bbox_inches="tight", format='pdf', backend='cairo')
#plt.savefig('Causal_EB.pdf', dpi=500, bbox_inches="tight", format='pdf', backend='cairo')
...
#CS1 = plt.tricontourf(x_test, t_test, u_test_pred, 20, cmap='twilight')
CS1 = plt.tricontourf(x_test, t_test, p_test, levels, cmap='Spectral_r')
#CS1 = plt.tricontourf(x_test, t_test, relative_error, 20, cmap='rainbow')
...
plt.savefig('Exact_timo_rotation.pdf', dpi=500, bbox_inches="tight", format='pdf', backend='cairo')
#plt.savefig('Causal_EB.pdf', dpi=500, bbox_inches="tight", format='pdf', backend='cairo')
