...
model_state_dict = torch.load('p4.pth', map_location=torch.device('cpu'))
...
plt.savefig('20_noisy_dotted.pdf', dpi = 500, bbox_inches = "tight", format='pdf', backend='cairo')
plt.show()
