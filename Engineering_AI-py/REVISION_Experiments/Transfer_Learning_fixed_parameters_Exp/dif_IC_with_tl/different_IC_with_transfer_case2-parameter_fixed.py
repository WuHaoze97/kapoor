...
# torch.save(model_state_dict, 'p_ic_c2.pth)



# +

# with open('p_ic_c2.pkl', 'wb') as f:
#     pickle.dump(history, f)
...
# model_state_dict = torch.load('p_ic_c2.pth', map_location=torch.device('cpu'))
