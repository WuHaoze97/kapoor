...
# +
params = []
params.append(my_network.input_layer.weight)
params.append(my_network.input_layer.bias)
for i in range(3):
    params.append(my_network.hidden_layers[i].weight)
    params.append(my_network.hidden_layers[i].bias)
torch.save(params, "my_network_3_EB_layers.pt")
