...
# with open('PINN_EB_hat.pkl', 'wb') as f:
...
# torch.save(model_state_dict, 'PINN_EB_hat.pth')
...
with open('PINN_EB_hat_function.pkl', 'rb') as f:
...
model_state_dict = torch.load('PINN_EB_hat_function.pth',  map_location=torch.device('cpu'))
...
plt.savefig('PINN_EB_wavelet.pdf', dpi = 300, bbox_inches = "tight")
...
plt.savefig('PINN_EB_WAVELET.pdf', dpi=500, bbox_inches="tight", format='pdf', backend='cairo')
#plt.savefig('Absolute_error_EB.pdf', dpi = 300, bbox_inches = "tight")
